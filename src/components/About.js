...
export default function About(props) {
    ...
    return (
        <div className = "container" style = {{color : props.mode==='dark'?'red ':'red'}}>
            <h2 className = "my-4">About Us</h2>
            <div className="accordion" style = {{backgroundColor : props.mode==='dark'?'black ':'white'}} id="accordionExample">
